...
{
	LCD_INIT();
	LCD_OUT(1,1,"NGUYEN QUANG MINH 1234"); // hien thi chuoi ky tu len hang 1 cot 1

	Delay_ms(3000);
	LCD_CMD(0x18); // sau 3 giay dich trai 1 lan
	
	Delay_ms(3000);
	LCD_CMD(0x18);// sau 3 giay dich trai 1 lan
	
	Delay_ms(3000);
	LCD_CMD(0x02); // khoi phuc trang thai hien thi ve ban dau
	
	while(1)
	{
//		Delay_ms(500);
//		LCD_CMD(0x1C);//dich toan bo sang phai
		
//		Delay_ms(500);
//		LCD_CMD(0x18);//dich toan bo sang trai
	}
}
